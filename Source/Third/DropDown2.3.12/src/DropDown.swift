...
public typealias MultiSelectionClosure = ([Index], [String],_ isSelect: Bool,  _ activeInde: Index) -> Void
...
public final class DropDown: UIView {
	...
	*/
	...
	public private(set) var selectedRowIndices = Set<Index>()
...
extension DropDown {
	...
	*/
    ...
    public var indexsForSelectedRows: [Index] {
	...
	public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if let multiSelectionCallback = multiSelectionAction {
            ...
            if selectedRowIndices.first(where: { $0 == selectedRowIndex}) != nil {
                ...
                multiSelectionCallback(selectedRowIndicesArray, selectedRows,false, indexPath.row)
                return
            }
            else {
                ...
                multiSelectionCallback(selectedRowIndicesArray, selectedRows,true, indexPath.row)
                tableView.reloadData()
                return
            }
        }
